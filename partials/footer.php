        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <p class="stext-107 cl7 size-201">
                    <?php echo $andmed['email']; ?><br>
                    <?php echo $andmed['aadress']; ?>
                    <br><?php echo $andmed['firmanimi']; ?>
                    <br><?php echo $andmed['regnr']; ?>
                </p>

                <div class="p-t-27">
                    <a href="<?php echo $andmed['facebook']; ?>" class="fs-18 cl7 hov-cl1 trans-04 m-r-16">
                        <i class="fa fa-facebook"></i>
                    </a>

                    <a href="<?php echo $andmed['instagram']; ?>" class="fs-18 cl7 hov-cl1 trans-04 m-r-16">
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <form action="handler/newsletter.php" method="POST">
                    <div class="wrap-input1 w-full p-b-4">
                        <input class="input1 bg-none plh1 stext-107 cl7" type="email" name="email" placeholder="email@gmail.com">
...
<!-- Modal1 -->
<div id="message<?php  ?>" class="wrap-modal1 js-modal1 p-t-60 p-b-20">
