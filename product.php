						...
						<div class="block2">
							...
							<div class="block2-txt flex-w flex-t p-t-14">
								...
								<div class="block2-txt-child2 flex-r p-t-3 ">
									<a href="carthandler.php?cart_id=<?php echo $final['prod_id']; ?>&cart_name=<?php echo $final['prod_name']; ?>&cart_price=<?php echo $final['price']; ?>&cart_picture=<?php echo $final['picture']; ?>&cart_quantity=1" class="btn-addwish-b2 dis-block pos-relative js-addcart-detail">
